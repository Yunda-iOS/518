...
@implementation NXNetworkCache

static NSString *const kNXNetworkResponseCache = @"kNXNetworkResponseCache";

static YYCache *_dataCache;

+ (void)initialize {
    _dataCache = [YYCache cacheWithName:kNXNetworkResponseCache];
}
